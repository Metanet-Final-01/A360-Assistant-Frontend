// 흐름도(Recommendation)를 사람이 읽는 Markdown으로 직렬화 — FR-17. 백엔드 export API는 JSON
// 봉투만 내려주므로(P1-3, 골든셋 채점 포맷 고정) Markdown 변환은 순수 프론트에서 한다. DOCX는
// 서식·흐름도 이미지까지 포함해 백엔드가 생성한다(RPA-296, api/recommend.js
// downloadRecommendationDocx). 라벨/패키지 폴백 규칙은 recommendation.js(캔버스·상세 패널이
// 쓰는 규칙)와 동일하게 맞춘다.
import { t } from "../i18n";
