export default {
  ...
  analysisTabs: {
    ...
    evidence: "원문 근거",
    flow: "추천 흐름도",
    summaryIntro: "업무정의서를 분석하여 총 {count}개의 주요 단계로 업무 흐름을 구조화했습니다.",
    systemsIntro: "각 단계에서 언급된 시스템/도구 {count}개를 식별했습니다.",
    evidenceIntro: "문서 원문에서 근거를 찾은 단계 {count}개입니다.",
    stepTableTitle: "업무 단계 요약",
    ambiguitiesTitle: "문서만으로 확정하지 못한 항목",
    inputsTitle: "입력 항목",
    outputsTitle: "출력 항목",
    ioStepHint: "오른쪽 숫자는 그 항목이 등장하는 단계 번호입니다.",
    usedInSteps: "{count}개 단계에서 사용",
    col: {
      order: "단계",
      name: "단계명",
      description: "설명",
  ...
  tutorial: {
    ...
    steps: [
      ...
      {
        title: "세션 이력",
        body: "왼쪽 사이드바에서 지난 분석 기록과 대화를 다시 볼 수 있습니다. 이 소개는 상단 헤더의 '기능 소개'(?) 버튼으로 언제든 다시 볼 수 있어요.",
      },
    ],
  },
  ...
  recommendDetail: {
    ...
    confidenceTooltip: "흐름도 수준 신뢰도 — 요구 커버리지 × 검증 결과 × 시뮬레이션 (v3)",
    analyzingWork: "업무를 분석하는 중…",
    ...
    flowConfidenceLabel: "흐름도 신뢰도 {percent}%",
    stepNoActions: "이 단계는 확정된 액션이 없습니다",
    questionsNeededTitle: "확인이 필요한 항목",
    requiredBadge: "필수",
    selectPlaceholder: "선택…",
    confirmPremise: "이 전제대로 진행합니다",
    defaultValuePlaceholder: "시안값: {default}",
    valuePlaceholder: "값을 입력하세요…",
    submittingCards: "반영 중…",
    submitCards: "응답 반영",
    violationMark: "검수 위반",
    containerTag: "컨테이너",
    actionFallback: "액션",
  ...
  recommendFlow: {
    ...
    exportDocxFailed: "DOCX 내보내기에 실패했습니다.",
  ...
  upload: {
    ...
    progress: {
      ...
      validate: "파일 검증",
      extract: "콘텐츠 추출",
      extractDone: "텍스트/표 추출 완료 ({page}p)",
      vision: "비전 보강",
      analyze: "업무 흐름 분석(LLM)",
      analyzeHint: "단계/입력/출력/시스템 식별 중",
      analyzeDone: "{count}개 단계 식별",
      flow: "추천 흐름도 생성",
      flowDone: "v{version} 생성 완료",
      stateDone: "완료",
      stateRunning: "진행 중",
      statePending: "대기",
      stateError: "실패",
  ...
  recommendation: {
    ...
    continuesHint: "다음 단계(또는 완료)로 이어짐",
    noBody: "(본문 없음)",
  },
